...
class KuhnMunkres(object):
    ...
    def __init__(self, weight_matrix):
        ...
        # cost_matrix 矩阵内容其实就是 weight_matrix 中每个数取相反的树
        self.cost_matrix = make_cost_matrix(weight_matrix)

    def run(self):
        m = Munkres()
        self.match = m.compute(self.cost_matrix)
        return self.match

"""
以下代码来源于 https://github.com/bmc/munkres
修改了部分代码，使其兼容于 python3
"""
# Constants
