...
def test_3():
    # 13 2 18
    issues = json.load(open(os.path.join(test_path, 'data/period_3_person_3_issues.json')))
    ...
    ep.process()
    assert ep.pair_success() == True
    # json.dump(ep.assignees_info, open(os.path.join(test_path, 'data/period_3_person_3_assignees_info.json'), "w"), ensure_ascii=False, indent=True)
