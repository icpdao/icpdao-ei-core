...
def test_first():
    issues = json.load(open(os.path.join(test_path, 'data/period_two_person_half_more_issues.json')))
    ...
    # json.dump(ep.assignees_info, open(os.path.join(test_path, 'data/period_two_person_half_more_assignees_info.json'), "w"), ensure_ascii=False, indent=True)
